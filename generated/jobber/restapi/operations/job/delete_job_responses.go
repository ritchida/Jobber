...
swagger:response deleteJobOK
*/
type DeleteJobOK struct {
}

// NewDeleteJobOK creates DeleteJobOK with default headers values
func NewDeleteJobOK() *DeleteJobOK {
	return &DeleteJobOK{}
}

// WriteResponse to the client
func (o *DeleteJobOK) WriteResponse(rw http.ResponseWriter, producer httpkit.Producer) {

	rw.WriteHeader(200)
}

/*DeleteJobDefault error
...
// WriteResponse to the client
func (o *DeleteJobDefault) WriteResponse(rw http.ResponseWriter, producer httpkit.Producer) {
